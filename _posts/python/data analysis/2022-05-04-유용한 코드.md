...
for  x  in  index_variables.values():
	all_predictors = all_predictors.union(set(x))
all_predictors = sorted(all_predictors)
all_predictors
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1MDc4MjMyNyw2MTM5Mzc0NDgsMjgxMT
c2NDI4LDIwODUzMjczMDYsLTEyNDc4MDE5MzEsLTE5MDYyMjU4
MTEsMjQ2OTcxMiwtMTU2Mzc5NTIzNSwtMTc3NzIxNTc1NCwtMj
E1Mzk0ODU3XX0=
-->