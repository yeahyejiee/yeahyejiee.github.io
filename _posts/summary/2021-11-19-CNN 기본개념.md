...
- convolutional base (이미지에서 일반적인 특징, 개념을 추출) + densely connected classifier(모델이 훈련된 클래스 집합에 특유한 특성을 지님, 다른 문제에 적용시 재사용 어렵)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTA2NzM0NTIsMTc5NDI5NTU1MCwyMD
